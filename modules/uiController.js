...
class UIController {
  ...
  setSongLayoutPreset(songId, preset) {
    const presets = {
      'lead-sheet': { columns: 1, columnRatios: [1], fontSize: 12, typography: 'sans', pageSize: 'letter', orientation: 'portrait', margin: 'narrow', margins: {top:null,right:null,bottom:null,left:null}, gutter: 18, sectionSpacing: 'compact', balance: 'auto' },
      stage: { columns: 2, columnRatios: [.5,.5], fontSize: 13, typography: 'sans', pageSize: 'letter', orientation: 'portrait', margin: 'standard', margins: {top:null,right:null,bottom:null,left:null}, gutter: 18, sectionSpacing: 'normal', balance: 'auto' },
      'large-print': { columns: 1, columnRatios: [1], fontSize: 16, typography: 'sans', pageSize: 'letter', orientation: 'portrait', margin: 'wide', margins: {top:null,right:null,bottom:null,left:null}, gutter: 18, sectionSpacing: 'spacious', balance: 'off' }
    };
